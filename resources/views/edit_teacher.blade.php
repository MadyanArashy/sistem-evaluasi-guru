  ...
  <div class="min-h-screen flex items-center justify-center px-4 relative z-10">
    <div class="content-card w-full max-w-2xl p-10 shadow-xl border border-white/20">
      ...
      <div class="flex items-center justify-center mb-10 gap-3">
        ...
        <h2 class="section-title text-indigo-400 text-3xl m-0 leading-none">Form Edit Guru</h2>
      </div>
        ...
        <div>
          ...
          <div class="relative">
            <x-text-input type="text" id="degree" name="degree" placeholder="Contoh: S.Pd, M.Kom"
              class="w-full pl-10 pr-4 py-2 border border-indigo-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" value="{{ old('degree', $teacher->degree) }}" />
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
        ...
        <div>
          ...
          <div class="relative">
            <x-text-input type="text" id="subject" name="subject" placeholder="Mata pelajaran yang diajarkan"
              class="w-full pl-10 pr-4 py-2 border border-indigo-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" value="{{ old('subject', $teacher->subject) }}" />
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
