...
<!-- Header -->
    <div class="px-8 pt-20" style="margin-left: 260px;">
            <h1 class="text-4xl font-extrabold text-blue-800 flex items-center gap-4 mb-2 tracking-wide drop-shadow">
                <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-yellow-300 shadow-md">
                    <i class="fa-solid fa-users text-blue-700 text-2xl animate-pulse"></i>
                </span>
                Data Guru
            </h1>
            <p class="text-sm text-blue-600 ml-16">
                Informasi Penilaian Guru SMK Informatika Pesat
            </p>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 border-l-8 border-yellow-400 mb-10 flex gap-6 items-center">
            ...
            <div class="space-y-1">
                ...
                <div class="flex items-center gap-2 text-yellow-700 text-sm">
                    ...
                    <span class="text-gray-800">S.Kom</span>
                </div>
                <div class="flex items-center gap-2 text-blue-700 text-sm">
                    <i class="fa-solid fa-book-open text-blue-500"></i>
                    <span class="font-medium">Mapel:</span>
                    <span class="text-gray-800">Informatika</span>
                </div>
            </div>
        </div>

        <!-- TABEL UTAMA -->
        <div class="overflow-x-auto bg-white rounded-xl shadow p-4 mb-20">
